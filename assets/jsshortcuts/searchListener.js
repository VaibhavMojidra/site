...
let arrayForSuggestionsOperations = [{ suggestedSection: "APPS", dropDownValue: "Search in Apps", suggestionInnerHTML: "Apps" }, { suggestedSection: "EDUCATION", dropDownValue: "Search in Education", suggestionInnerHTML: "Education" }, { suggestedSection: "GIT", dropDownValue: "Search in GitHub Repositories", suggestionInnerHTML: "GitHub Repositories" }, { suggestedSection: "HIGHLIGHTS", dropDownValue: "Search in Highlights", suggestionInnerHTML: "Highlights" }, { suggestedSection: "PROFESSIONAL_C", dropDownValue: "Search in Professional Certification", suggestionInnerHTML: "Professional Certification" }, { suggestedSection: "INSTITUTE_C", dropDownValue: "Search in Institute Certification", suggestionInnerHTML: "Institute Certificatio" }, { suggestedSection: "ONLINE_C", dropDownValue: "Search in Online Certification", suggestionInnerHTML: "Online Certification" }, { suggestedSection: "OTHER_C", dropDownValue: "Search in Other Certification", suggestionInnerHTML: "Other Certification" }, { suggestedSection: "SKILLS", dropDownValue: "Search in Skills", suggestionInnerHTML: "Skills" }, { suggestedSection: "SOCIAL", dropDownValue: "Search in Socials & Other Accounts", suggestionInnerHTML: "Socials & Other Accounts" }, { suggestedSection: "WORK", dropDownValue: "Search in Work Experience", suggestionInnerHTML: "Work Experience" }, { suggestedSection: "AWARD", dropDownValue: "Search in Awards", suggestionInnerHTML: "Awards" }]
let threshold = 0.4
