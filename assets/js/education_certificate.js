...
let onlineCertificateList = [
	...
	},
	{
		...
		instituteName: "Coursera",
		instituteIcon: "assets/img/icons/coursera_icon.jpeg",
		courseContent: ["Google Project Management", "Understanding the basics of project management", "What is project management?", "Learning about careers in project management", "Exploring how a project manager adds value", "Becoming an effective project manager", "The value of a project manager", "How project managers impact organizations", "Learning more about project manager roles and responsibilities", "Key project manager roles and responsibilities", "A project manager’s role within a team", "Acquiring the core skills of a successful project manager", "Becoming an effective project manager", "Understanding the project life cycle", "Analyzing the different project phases", "Understanding project life cycles", "Comparing project management methodologies and approaches", "Overview of Waterfall and Agile", "Understanding organizational structure", "Understanding the impact of organizational culture", "Understanding change management", "Foundations of project management"],
